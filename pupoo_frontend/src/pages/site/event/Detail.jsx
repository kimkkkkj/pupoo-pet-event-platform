...
const styles = `
  ...
  .dt-nav-btn:hover { background: #f8f9fc; color: #111827; }
  .dt-nav-btn.active { background: #90C450; color: #fff; font-weight: 600; }
  ...
  .dt-event-tab:hover { border-color: #90C450; }
  .dt-event-tab.active { border-color: #90C450; background: #eff4ff; }
  .dt-event-tab-name { font-size: 13px; font-weight: 700; color: #111827; }
  .dt-event-tab.active .dt-event-tab-name { color: #90C450; }
  ...
  .dt-hero-btn.solid { background: #fff; color: #90C450; border: none; font-weight: 700; }
  ...
  .dt-tl-item:hover .dt-tl-title { color: #90C450; }
...
const EVENTS = [
  {
    ...
    capacity: 1200,
    registered: 748,
    gradient: "linear-gradient(135deg, #90C450 0%, #6366f1 100%)",
              ...
              <div className="dt-card-header">
                <div className="dt-card-title">
                  <div className="dt-card-title-icon">
                    <CalendarDays size={14} color="#90C450" />
                  </div>
                  세부 일정
                </div>
              </div>
